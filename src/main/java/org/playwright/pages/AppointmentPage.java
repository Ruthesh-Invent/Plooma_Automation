...
//	}
	...
	public void selectDropdownByFieldNameAndValue(String fieldName, String value) {
		Locator dropdown = getPage().locator("//mat-label[normalize-space(text())='" + fieldName
				+ "']/ancestor::div[contains(@class,'mat-form-field-infix')]/input[@role='combobox']");
...
//	}
	...
	public void saveAppointmentHandleAllPopups() {
		...
		sleepSeconds(5);
		Locator conflictYesButton = getPage()
				.locator("//a[normalize-space()='Yes' and contains(@class, 'mat-primary')]");
